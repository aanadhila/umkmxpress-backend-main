        ...
        <div class="app-container container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                <a href="{{ route('home') }}" class="d-lg-none">
                    <img alt="Logo" src="{{ asset('assets/img/logo-only.png') }}" class="h-30px" />
                </a>
                <span class="d-lg-none">
                    @role('Kurir')
                        Saldo : Rp {{ number_format(auth()->user()->courier->wallet->balance, 0, ',', '.') }}
                    @endrole
                </span>
            </div>
            <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true"
                    data-kt-drawer-width="225px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}"
                    ...
                    <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                        <div data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion menu-here-bg me-0 me-lg-2">
                            <span class="menu-link">
                                <span class="menu-title">{{ auth()->user()->name }} @foreach (auth()->user()->roles as $role)
                                        | {{ $role->name }}
                                    @endforeach
                                    @role('Kurir')
                                        Saldo : Rp {{ number_format(auth()->user()->courier->wallet->balance, 0, ',', '.') }}
                ...
                <div class="app-navbar flex-shrink-0">
                    ...
                    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-3 fs-6 w-150px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-5">
                                <form action="{{ route('logout') }}" method="POST" id="logoutForm">
                                    @csrf
                                    <a class="menu-link px-3 py-2" role="button" type="submit" onclick="$('#logoutForm').submit()">
                                        <span class="menu-icon" data-kt-element="icon">
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
