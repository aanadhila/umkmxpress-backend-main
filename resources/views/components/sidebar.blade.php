<div>
    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px"
        data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
        <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
            <a href="{{ route('home') }}">
                <img alt="Logo" src="{{ asset('assets/img/logo.png') }}" class="h-30px app-sidebar-logo-default" />
                <img alt="Logo" src="{{ asset('assets/img/logo-only.png') }}" class="h-25px app-sidebar-logo-minimize" />
            </a>
            ...
            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    @role('Super Admin|Admin')
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('shipments*') ? 'active' : '' }}" href="{{ route('shipments.index') }}">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Route::is(['payments*', 'methods*']) ? 'show' : '' }}">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('payments.index') ? 'active' : '' }}" href="{{ route('payments.index') }}">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('methods.index') ? 'active' : '' }}" href="{{ route('methods.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('expeditions.index') ? 'active' : '' }}" href="{{ route('expeditions.index') }}">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('costs.index') ? 'active' : '' }}" href="{{ route('costs.index') }}">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                ...
                                <span class="menu-title">Tarif Khusus</span>
                            </a>
                        </div>
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Route::is(['clusters*', 'sender-packets*']) ? 'show' : '' }}">
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                ...
                                <span class="menu-title">Klusterisasi Wilayah</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('clusters.index') ? 'active' : '' }}" href="{{ route('clusters.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('sender-packets.index') ? 'active' : '' }}" href="{{ route('sender-packets.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Route::is(['couriers*', 'wallets*']) ? 'show' : '' }}">
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                ...
                                <span class="menu-title">Courier Management</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('couriers.index') ? 'active' : '' }}" href="{{ route('couriers.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('wallets.index') ? 'active' : '' }}" href="{{ route('wallets.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Data Transaksi Saldo</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    @endrole
                    @can('Users')
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Route::is(['users*', 'senders*', 'recipients*']) ? 'show' : '' }}">
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('senders.index') ? 'active' : '' }}" href="{{ route('senders.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::is('recipients.index') ? 'active' : '' }}" href="{{ route('recipients.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                    ...
                    @endcan
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('testing*') ? 'active' : '' }}" href="{{ route('testing.orders.index') }}">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                            <path fill="currentColor"
                                ...
                                <span class="menu-title">Pickup Pesanan</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('wallets.index') ? 'active' : '' }}" href="{{ route('wallets.index') }}">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-muted svg-icon-2"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @role('Super Admin|Admin')
                        {{-- <div class="menu-item">
                            <a class="menu-link {{ Route::is('apis.index') ? 'active' : '' }}" href="{{ route('apis.index') }}">
                                <span class="menu-icon">
        ...
        {{-- <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
            <a href="../../demo1/dist/documentation/getting-started.html" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover"
